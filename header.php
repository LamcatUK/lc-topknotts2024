            ...
            <div class="container-xl">
                ...
                wp_nav_menu(
                    array(
                        ...
                        'container_class' => 'collapse navbar-collapse navbars pt-4 pt-xl-0',
                        'container_id'    => 'primaryNav',
                        'menu_class'      => 'navbar-nav w-100 justify-content-xl-between align-items-xl-center gap-lg-2 mx-4',
                        'fallback_cb'     => '',
                        'menu_id'         => 'main-menu',
                        'depth'           => 2,
